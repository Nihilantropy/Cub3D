...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/01/09 11:02:23 by mcantell          #+#    #+#             */
/*   Updated: 2025/01/09 11:05:10 by mcantell         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 *
 * This function checks the time elapsed since the last frame and,
 ...
 *
 * This function creates a new image and sets up the necessary data pointer
 *  for the frame buffer.
 *
 * @param game The game state that provides access to
 *  the display dimensions and mlx pointer.
