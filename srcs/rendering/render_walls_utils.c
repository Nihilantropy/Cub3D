...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/01/09 11:02:26 by mcantell          #+#    #+#             */
/*   Updated: 2025/01/09 11:06:38 by mcantell         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
*
* Computes wall hit point and determines texture x-coordinate
...
{
	if (slice->side == 0)
		slice->wall_x = game->player.pos.y + cam->perp_wall_dist
			* cam->ray_dir_y;
	else
		slice->wall_x = game->player.pos.x + cam->perp_wall_dist
			* cam->ray_dir_x;
