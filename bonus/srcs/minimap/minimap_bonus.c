...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/01/09 11:57:53 by mcantell          #+#    #+#             */
/*   Updated: 2025/01/09 11:58:28 by mcantell         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	get_minimap_dimension(t_game *game)
{
	...
	minimap->width = game->map.width * minimap->tile_size
		+ 2 * MINIMAP_BORDER_SIZE;
	minimap->height = game->map.height * minimap->tile_size
		+ 2 * MINIMAP_BORDER_SIZE;
